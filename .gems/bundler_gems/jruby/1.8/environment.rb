...
module Bundler
 ...
 dir = File.dirname(file)
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/crack-0.1.7/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/oauth-0.3.6/bin")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/oauth-0.3.6/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/hashie-0.1.8/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/agnostic-0.1.1/lib")
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/dm-pagination-0.4.0/lib")
  ...
  $LOAD_PATH.unshift File.expand_path("#{dir}/gems/twitter-0.8.4/lib")
